    ...
    <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
        <div className='flex flex-col justify-center h-full'>
            ...
            <p className='text-gray-500 py-4 max-w-md'>
                ...
                Currently, I love to work on web applications using technologies like React, Tailwind, Symfony and Laravel.
            </p>
        ...
        <div>
            <img src={Profil} alt="my portfolio" className='rounded-2xl mx-auto w-2/3 md:w-full'/>
        </div>
    </div>
</div>
  )
